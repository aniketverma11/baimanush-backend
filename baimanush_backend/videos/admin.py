...
class VideoAdmin(ImportExportModelAdmin):
    ...
    list_display = ('slug','title', 'short_description', 'publish', 'category', 'minutes_read', 'author',"home_screen", 'is_for_members', 'is_draft', 'is_trending','publish', "created", 'created_by')
