...
class PhotosAdmin(ImportExportModelAdmin):
    ...
    list_display = ('slug','title', 'short_description', 'publish', 'category', 'minutes_read', 'author', 'is_for_members',"home_screen", 'is_draft' ,'publish','is_trending', "created", 'created_by')
